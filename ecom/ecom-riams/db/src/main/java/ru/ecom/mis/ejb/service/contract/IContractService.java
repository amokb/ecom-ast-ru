...
public interface IContractService {
	...
	void addMedServiceAccount(String typeService, Long id, String medServiceCode, Long patientId, ContractGuarantee letter, EntityManager manager);

	String getGuaranteeLimit(Long id, EntityManager manager);
}
