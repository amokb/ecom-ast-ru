...
([function (t, e, n) {
    ...
    function r(t) {
        function e(t) {
            if (Array.isArray(t))
                ...
                t.text = t.text || "", t.data = t.data || "", n.push(t)
        }
        var n = [];
        return e(t),
            n
    ...
    function o(t, e, n) {
        ...
        var r = new e(t, n);
        if (!r.valid())
            throw new E.InvalidInputException(r.constructor.name, t);
        var o = r.encode();
        o = (0, p.default)(o);
    ...
    var a = n(15),
        ...
        x = function (t, e, n) {
            ...
            return r._renderProperties = (0, b.default)(t),
                r._encodings = [],
    ...
    for (var P in f.default)
        f.default.hasOwnProperty(P) && function (t, e) {
    ...
    j.prototype.options = function (t) {
        return this._options = (0, s.default)(this._options, t),
            this
    },
        ...
        j.prototype.render = function () {
            ...
            if (Array.isArray(this._renderProperties))
                ...
                u(this._renderProperties, this._encodings, this._options);
            return this
        },
        ...
        l = function (t) {
            function e(t, n) {
                if (o(this, e), /^[\x00-\x7F\xC8-\xD3]+$/.test(t))
                    var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, (0, s.default)(t), n));
                else
                    var r = i(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n));
                return i(r)
            }
    ...
    function o(t) {
        ...
        for (var n in f.default)
            f.default.hasOwnProperty(n) && (t.hasAttribute("jsbarcode-" + n.toLowerCase()) && (e[n] = t.getAttribute("jsbarcode-" + n.toLowerCase())), t.hasAttribute("data-" + n.toLowerCase()) && (e[n] = t.getAttribute("data-" + n.toLowerCase())));
